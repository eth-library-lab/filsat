...
This project is a GraphQL API for the server side of the project [Dsyntdocs](https://github.com/eth-library-lab/filsat) developed in [Python](https://www.python.org).
