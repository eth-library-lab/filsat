...
import { win, getHostRef, styles, supportsConstructibleStylesheets, doc, plt, supportsShadowDom, isMemberInElement, consoleError, nextTick, writeTask, supportsListenerOptions, loadModule, registerHost, getElement as getElement$1, Context, getAssetPath as getAssetPath$1, readTask } from '@stencil/core/platform';
